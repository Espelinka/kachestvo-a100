...
// Simplified PDF opening function - opens PDF directly without prompting
...
DOMReady(() => {
  try {
    ...
    // Check if site is running offline
    window.addEventListener('online', () => {
      console.log('Сайт снова онлайн');
    });
    
    window.addEventListener('offline', () => {
      console.log('Сайт работает в автономном режиме');
